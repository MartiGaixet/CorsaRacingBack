    ...
    public partial class inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParticipationRace", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParticipationRace_Drivers_UserId",
                        column: x => x.UserId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParticipationRace_Races_RaceId",
                        column: x => x.RaceId,
                        principalTable: "Races",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParticipationRace_RaceId",
                table: "ParticipationRace",
                column: "RaceId");

            migrationBuilder.CreateIndex(
                name: "IX_ParticipationRace_UserId",
                table: "ParticipationRace",
                column: "UserId");
